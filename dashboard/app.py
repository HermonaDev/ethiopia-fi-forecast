...
if page == "Overview":
    ...
    st.info(
        "Interoperable P2P digital transfers have surpassed ATM "
        "cash withdrawals for the first time in 2024."
    )
    ...
    fig = px.line(
        subset, x='observation_date',
        y='value_numeric', markers=True
    )
